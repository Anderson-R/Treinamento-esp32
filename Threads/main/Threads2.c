...
void thread1(void* arg)
{
    ...
    while (true)
    {
        ...
        for(int i=0; i<CONFIG_THREAD_1_NUMBER; i++)
            ESP_LOGW(TAG, CONFIG_THREAD_1_MESSAGE);
        vTaskDelay( xDelay );
    }
...
void thread2(void* arg)
{
    ...
    while (true)
    {
        ...
        for(int i=0; i<CONFIG_THREAD_2_NUMBER; i++)
            ESP_LOGW(TAG, CONFIG_THREAD_2_MESSAGE);
        vTaskDelay( xDelay );
    }
...
void thread3(void* arg)
{
    ...
    while (true)
    {
        ...
        for(int i=0; i<CONFIG_THREAD_3_NUMBER; i++)
            ESP_LOGW(TAG, CONFIG_THREAD_3_MESSAGE);
        vTaskDelay( xDelay );
    }
